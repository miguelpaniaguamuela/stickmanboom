...
var Enemy = function (_Phaser$Sprite) {
    ...
    function Enemy(_ref) {
        ...
        console.log(_this.game.width);
        _this.scale.setTo(_this.game.width / 1920, _this.game.height / 1080);
        _this.health = health;
        _this.maxHealth = health;
        _this.game.physics.arcade.enable(_this);
        _this.animations.add('run', [0, 1, 2, 3, 4, 5, 6, 7], 20, true);
        _this.play('run');
...
module.exports = __webpack_require__(/*! C:\xampp\htdocs\projects\juego\src\main.js */333);
...
var _enemy = __webpack_require__(/*! ./entities/enemy */ 127);
...
var _Preload = __webpack_require__(/*! ./states/Preload */ 339);
...
var _Play = __webpack_require__(/*! ./states/Play */ 343);
...
var Game = function (_Phaser$Game) {
  ...
  function Game() {
    ...
    var _this = _possibleConstructorReturn(this, (Game.__proto__ || Object.getPrototypeOf(Game)).call(this, 1920, 1080, _phaser2.default.CANVAS, 'content', null));
...
var _class = function (_Phaser$State) {
  ...
  _createClass(_class, [{
    ...
    value: function create() {
      ...
      game.scale.scaleMode = _phaser2.default.ScaleManager.SHOW_ALL;
...
var _textbutton = __webpack_require__(/*! ../others/textbutton */ 342);
...
var _class = function (_Phaser$State) {
    ...
    _createClass(_class, [{
        ...
        value: function create() {
            ...
            this.title = new _phaser2.default.Text(this.game, this.game.world.centerX, this.game.world.centerY - 200, '', {
                font: '36px Tahoma',
                fill: 'white',
                align: 'center'
            });
...
var _Mushroom = __webpack_require__(/*! ../sprites/Mushroom */ 344);
...
var _class = function (_Phaser$State) {
  ...
  _createClass(_class, [{
    ...
    key: 'onDown',
    value: function onDown(sprite, pointer) {
